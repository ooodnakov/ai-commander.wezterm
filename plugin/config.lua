...
local config = {
    ...
    command_context_output_lines = 40, -- Recent terminal output lines for command generation; 0 disables
    command_context_output_chars = 6000, -- Character cap for recent terminal output context; 0 disables
